...
test "PCX bpp1 (linear)" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "tests/fixtures/pcx/test-bpp1.pcx");
    defer file.close();
...
test "PCX bpp4 (linear)" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "tests/fixtures/pcx/test-bpp4.pcx");
    defer file.close();
...
test "PCX bpp8 (linear)" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "tests/fixtures/pcx/test-bpp8.pcx");
    defer file.close();
...
test "PCX bpp24 (planar)" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "tests/fixtures/pcx/test-bpp24.pcx");
    defer file.close();
